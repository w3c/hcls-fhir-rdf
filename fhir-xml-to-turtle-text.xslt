...
<xsl:stylesheet version="1.0"
  ...
  <xsl:variable name="title">
	...
	<xsl:value-of select="/*/n1:text/xhtml:div/xhtml:*[starts-with(name(), 'h')]"/>
      ...
      <xsl:when test="string-length(/*/n1:text/xhtml:div[child::text()])  &gt;= 1"> <!-- !! doesn't work with e.g. <div><p>asdf</p></div> -->
	<xsl:value-of select="/*/n1:text/xhtml:div[child::text()]"/>
      </xsl:when>
      <xsl:otherwise>
  ...
  <xsl:template name="body">
    <pre class="machine">
      <span class="comment"># <xsl:value-of select="$title"/></span><xsl:value-of select="'&#10;'"/>
      <span class="comment"># generated by fhir-xml-to-turtle.xslt<xsl:if test="$now"> <xsl:value-of select="concat(' ', $now)"/></xsl:if></span><xsl:value-of select="'&#10;'"/>
    </pre>
